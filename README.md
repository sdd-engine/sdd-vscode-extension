...
The extension watches for `.sdd/workflows/` directories in your workspace and renders workflow state in real-time. It reads `workflow.yaml` files and displays:
...
- An SDD project with `.sdd/` directory (or `sdd/` directory)
